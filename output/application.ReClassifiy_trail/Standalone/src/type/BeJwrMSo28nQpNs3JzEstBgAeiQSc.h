...
#ifndef BEJWRMSO28NQPNS3JZESTBGAEIQSC_H_
#define BEJWRMSO28NQPNS3JZESTBGAEIQSC_H_
...
#define SELF BeJwrMSo28nQpNs3JzEstBgAeiQSc
...
public:
    ...
    SELF() : Tuple(), ID_(), lines_() {}
    SELF(const Self & ot) : Tuple(), ID_(ot.ID_), lines_(ot.lines_) 
      { constructPayload(ot); }
    SELF(const ID_type & _ID, const lines_type & _lines) : Tuple(), ID_(_ID), lines_(_lines) { }
...
#undef SELF
#endif // BEJWRMSO28NQPNS3JZESTBGAEIQSC_H_ 
