/* Generated by Streams Studio: August 16, 2016 at 11:48:51 AM GMT+8 */
package application;
 ...
 */
@PrimitiveOperator(name="C50JavaOP", namespace="application",
description="Java Operator C50JavaOP")
...
public class C50JavaOP extends AbstractOperator {
	private C50classifier c50tree= new C50classifier();
	public static Gameboy producer;
    ...
    public final void process(StreamingInput<Tuple> inputStream, Tuple tuple)
        ...
        int x=0;
        x=inputStream.getPortNumber();
        //System.out.println(x);
        if(x==0){
        	c50tree.growtree(tuple.getString("lines"));
        	System.out.println(tuple.getString("lines"));
        }else{
        	String line= tuple.getString("lines");
    		line = line.replace("\n", "").replace("\r", "");
    		String [] Data_feature=line.split(",");
    		if(Data_feature.length==13){
    			outTuple.setString("ID", "NULL");
    			outTuple.setString("lines", c50tree.prediction(Data_feature));
    			System.out.println(c50tree.prediction(Data_feature));
    		}else if (Data_feature.length==14){
    			outTuple.setString("ID", Data_feature[0]);
    			outTuple.setString("lines", c50tree.prediction(Arrays.copyOfRange(Data_feature,1,14)));
    			System.out.println(Data_feature[0]+","+c50tree.prediction(Arrays.copyOfRange(Data_feature,1,14)));
    ...
    public void processPunctuation(StreamingInput<Tuple> stream,
        ...
        if(x==0){
	        ...
	        if(mark.equals(Punctuation.FINAL_MARKER)){
	        	System.out.println("=========I want to sent punctuation===========");
	        	outStream.submit(outTuple);
	        }
        }
